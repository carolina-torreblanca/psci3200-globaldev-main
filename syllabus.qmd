...
Global development increasingly relies on data and quantitative evidence to inform policies that affect how resources are allocated and, ultimately, whose lives are impacted. The growth of new data sources and advances in computational tools have expanded what researchers can study and how precisely they can study it, creating the possibility of better-informed responses to long-standing challenges such as poverty, inequality, and governance. 
