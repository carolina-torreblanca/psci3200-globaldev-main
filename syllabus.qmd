...
-   We will have **four** workshops throughout the semester. These will be interactive, hands-on workshops allowing students to gain familiarity with new computational tools. After each workshop, you will be required to submit a product demonstrating completion of the workshop. Workshop submissions are graded pass/fail.
-   Grade: 15%

| Workshop | Submission | Due Date |
|:---------|:-----------|:---------|
| R/RStudio and Quarto | Rendered Quarto document | Feb 2 |
| GitHub | Push to your repo | Mar 2 |
| Final Project Essentials | TBD | Mar 30 |
| Text as Data | TBD | Apr 1 |

**Data Assignments**

-   There will be **three** data assignments throughout the semester. These assignments are touch-points that build toward your final project. Each assignment asks you to develop and refine a component of your final project. These are individual assignments. While I encourage you to collaborate with your colleagues as you think through the tasks, you will be required to submit your own code and write-up.
-   Grade: 35%

| Data Assignment | Description | Due Date |
|:----------------|:------------|:---------|
| Assignment 1 | Research Question and Dataset | Feb 23rd 11:59pm ET |
| Assignment 2 | Research Design | Mar 18th 11:59pm ET |
| Assignment 3 | Expanded Research Design | Apr 15th 11:59pm ET |
