...
2.  
    ...
    ![It should look something like this](img/rlookslike.png)

<!-- -->

2.  **Download RStudio from** [the RStudio Posit website](https://posit.co/download/rstudio-desktop/) - Scroll down to find the latest version that matches your OS
