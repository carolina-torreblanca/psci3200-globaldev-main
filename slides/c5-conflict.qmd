...
ggplot() +
  ...
  # Excluded: Z -> Y (red, curved below)
  curve_arrow(0.4, -0.2, 3.6, -0.2, -0.4, "#d62728", "dotted", 0.9) +
  annotate("text", x = 2, y = -0.7, label = "X  exclusion restriction",
           size = 4, color = "#d62728", fontface = "italic") +
  # Excluded: U -> Z (red, curved above)
  curve_arrow(2.7, 1.4, 0.3, 0.25, -0.3, "#d62728", "dotted", 0.9) +
  annotate("text", x = 0.9, y = 1.3, label = "X  independence",
           size = 4, color = "#d62728", fontface = "italic") +
  # Nodes
