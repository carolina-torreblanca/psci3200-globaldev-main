...
subtitle: "The Causes of Civil War"
...
ggplot() +
  ...
  # Excluded: Z -> Y (red, curved down below the diagram)
  curve_arrow(0.4, -0.15, 3.6, -0.15, -0.4, "#d62728", "dotted", 0.9) +
  annotate("text", x = 2, y = -0.85, label = "X  exclusion restriction",
           size = 4, color = "#d62728", fontface = "italic") +
  # Excluded: U -> Z (red, curved up above the diagram)
  curve_arrow(2.7, 1.4, 0.3, 0.25, -0.3, "#d62728", "dotted", 0.9) +
  annotate("text", x = 0.9, y = 1.8, label = "X  independence",
           size = 4, color = "#d62728", fontface = "italic") +
  # Nodes
