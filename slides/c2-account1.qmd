...
- ~110,000 households, ~600,000 people
...
The slope on study is now $\beta_1 + \beta_3$. This is the line for students who slept well

. . .

$\beta_3$ is the difference between the two slopes

It tells you: does studying help **more** (or less) if you slept well?

## Reading the Output

- If $\beta_3 \approx 0$: same slopes, studying helps the same amount regardless of sleep

- If $\beta_3 \neq 0$: different slopes, the effect of studying depends on whether you slept
