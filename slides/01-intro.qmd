...
- Four data assignments designed to make sure you are keeping up with the tools covered in class and making progress in your final project. 
- For assignments where you are required to submit something, you will be required to submit your own code and write-up.
- You can see the date of each assignment on the schedule
...
| Milestone                    | Due Date                 |
|:-----------------------------|:-------------------------|
| Create a GitHub repository   | Feb 11th |
| Identify data source         | Mar 11th |
| Submit proposal              | Mar 30th |
| Submit final project         | April 29th |
...
##  {#slide4-id background-iframe="https://carolina-torreblanca.github.io/psci3200-globaldev-main/schedule.html" background-interactive="true" data-menu-title="Schedule"}
