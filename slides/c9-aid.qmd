...
::: incremental
- **Treatment**: lumping food relief with infrastructure means testing noise; aid type determines the expected time horizon for any effect
- **Outcome**: GDP per capita is the standard, but aid also targets health, institutions, and resilience that GDP misses in the short run
- **Identification**: an invalid instrument injects bias rather than isolating clean variation
:::

. . .

Fix these three things and the divergent findings converge
