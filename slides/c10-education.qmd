...
- Very different policy: cheap signals (tests, licenses) could do the same job
:::
...
- If intensity still predicts differences, parallel trends fails
...
- In this setting, ability bias was not huge
- Key point: this is a *causal* estimate, not a correlation
:::
...
A spillover: *your* action changes *someone else's* outcome
...
## The Democracy Channel

::: incremental
- Lipset (1959): education → civic capacity → democracy
- Acemoglu et al. (2008): add country fixed effects and the cross-country link disappears
- Grossman et al. (2021): within-country effects are context-dependent; information reaches citizens, but whether they act on it depends on the political system
- Effects on *regime type* are weaker than effects on *individual political behavior*
:::
